            ...
            <div class="add-new-popup z-[999] fixed transition-all inset-0 overflow-x-hidden overflow-y-auto"
                ...
                <div class="popup-dialog flex transition-all max-w-[550px] min-h-full items-center mx-auto">
                    <div class="trezo-card w-full bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                        ...
                        <form action="{{ route('account.user.store') }}" method="post" autocomplete="off">
                            @csrf
                            <div class="trezo-card-content pb-[20px] md:pb-[25px]">
                                ...
                                <x-form.input label="Phone Number" id="phone" name="phone" :required="true" />
                                <x-form.input label="Address" id="address" name="address" :required="true" />
                            </div>
                            <div
                            ...
                            <tr>
                                ...
                                <td
                                    ...
                                    <div class="flex items-center gap-[9px]">
                                        <a href="{{ route('account.user.edit', $user) }}"
                                        ...
                                        <form action="{{ route('account.user.destroy', $user) }}" method="POST"
                                            class="inline">
                                            @method('DELETE')
                                            @csrf
